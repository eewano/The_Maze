...
public class ManagerPlayerMaster : MonoBehaviour {
    ...
    private event EveHandPlayerValue playerIntarvalDown;
    ...
    void Start() {
        ...
        playerIntarvalDown += new EveHandPlayerValue(mgrPlayerBtnCtrl.PlayerBtnIntervalChange);
        ...
        playerIntarvalDown += new EveHandPlayerValue(mgrPlayerKeyCtrl.PlayerKeyIntervalChange);
